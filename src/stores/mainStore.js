...
export const useMainStore = defineStore('main', () => {
  ...
  async function syncAll() {
    // getSession() + onAuthStateChange() can fire together on app launch.
    // Reuse the same in-flight request instead of downloading the same private data twice.
    if (syncPromise) return syncPromise

    isInitialSyncing.value = !hasInitialData.value
    syncPromise = (async () => {
  ...
  return { 
    ...
    isInitialSyncing, hasInitialData
  }
})